...
?>
        ...
        <div class="cart mt40">
            <h2><div class="cube"></div><strong><i><?php echo $this->_var['lang']['goods_list']; ?></i></strong></h2>
            <div class="cart-main">
              <div class="cart-table-th clearfix">
                <div class="th-item fl pl20"><b><?php echo $this->_var['lang']['goods_name']; ?></b></div>
                 <?php if ($this->_var['show_goods_attribute'] == 1): ?>
                    <div class="th-info fl"><?php echo $this->_var['lang']['goods_attr']; ?></div>
                 <?php endif; ?>
                <div class="th-price fl"><?php echo $this->_var['lang']['shop_prices']; ?></div>
                <div class="th-amount fl"><?php echo $this->_var['lang']['number']; ?></div>
                <div class="th-sum fl"><?php echo $this->_var['lang']['subtotal']; ?></div>
                <div class="th-op fl"><?php echo $this->_var['lang']['handle']; ?></div>
              </div>
            </div>
                    ...
                    <li class="td-item fl">
                        <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                          ...
                          <?php elseif ($this->_var['show_goods_thumb'] == 2): ?>
                              <div class="td-inner">
                                <div class="item-pic fl"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" width="80" height="80" alt=""></a></div>
                              </div>
                          <?php else: ?>
                              <div class="td-inner">
                                <div class="item-pic fl"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" width="80" height="80" alt=""></a></div>
                                <div class="item-info fl ml10">
                                  <div class="item-basic-info"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>"><?php echo $this->_var['goods']['goods_name']; ?></a></div>
                                </div>
                              </div>
                          <?php endif; ?>
...
?>
                    ...
                    <?php if ($this->_var['show_goods_attribute'] == 1): ?>
                        <li class="td-info fl">
                          <p class="sku-line"><?php if ($this->_var['goods']['goods_attr'] != ''): ?><?php echo nl2br($this->_var['goods']['goods_attr']); ?><?php else: ?>&nbsp;<?php endif; ?></p>
                        </li>
                    <?php endif; ?>
                    
                    <li class="td-price fl"><?php echo $this->_var['goods']['goods_price']; ?></li>

                    <li class="td-amount fl">
                      

                        <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
                        <input  class="addreduce hand" name="" type="button" value="-" onclick="setAmount('reduce', 'goods_number_<?php echo $this->_var['goods']['rec_id']; ?>')"/>
                        <input  name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" type="text" value="1" style="width:30px; text-align:center; border:1px solid #ccc;" onkeydown="showdiv(this)"/>
                        <input  class="addreduce hand" name="" type="button" value="+" onclick="setAmount('add', 'goods_number_<?php echo $this->_var['goods']['rec_id']; ?>')"/>
                        <?php else: ?>
                        <?php echo $this->_var['goods']['goods_number']; ?>
                        <?php endif; ?>
                    </li>

                    <li class="td-sum fl"><b class="color02" id="total1"><?php echo $this->_var['goods']['subtotal']; ?></b></li>
                ...
                <div class="cal-bar mt10 clearfix">
                    <div class="cal-bar-hd">
                  ...
                  <?php echo $this->_var['shopping_money']; ?><?php if ($this->_var['show_marketprice']): ?>，<?php echo $this->_var['market_price_desc']; ?><?php endif; ?>
                      <div class="op-cart"><a href="javascript:;" title="" onclick="location.href='flow.php?step=clear'"><?php echo $this->_var['lang']['clear_cart']; ?></a>
                      <input name="submit" type="submit" class="update hand" value="<?php echo $this->_var['lang']['update_cart']; ?>" /></div></div>
                    <div class="cal-bar-bd clearfix">
                      <div class="gonshop fl"><a href="./index.php"><img src="themes/default/images/robot/shoping.gif" alt=""></a></div>
                      <div class="paycenter fr"><a href="flow.php?step=checkout"><img src="themes/default/images/robot/settlement.gif" alt=""></a></div>
                    </div>
                </div>
                ...
                <?php echo $this->smarty_insert_scripts(array('files'=>'transport.js')); ?>
                 <script type="text/javascript" charset="utf-8">
                  function collect_to_flow(goodsId)
                  {
                    ...
                    goods.number   = number;
                    goods.parent   = 0;
                    Ajax.call('flow.php?step=add_to_cart', 'goods=' + objToJSONString(goods), collect_to_flow_response, 'POST', 'JSON');
                  }
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/default/images/robot/bnt_subOrder.gif" />
...
?>
        ...
        <div class="flowBox">
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="5" bgcolor="#fff" class="tab">
          <tr>
            <td width="50%" valign="top" bgcolor="#ffffff">
            <h6><span>用户登录：</span></h6>
            <form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
                <table width="99%" border="0" cellpadding="8" cellspacing="1" bgcolor="#FCEADC" class="table">
                  <tr>
                  ...
                  <tr>
                    ...
                    <td bgcolor="#ffffff" ><div align="left">
                        <input type="submit" class="nor_btn" name="login" value="<?php echo $this->_var['lang']['forthwith_login']; ?>" />
                        <?php if ($this->_var['anonymous_buy'] == 1): ?>
                        <input type="button" class="nor_btn" value="<?php echo $this->_var['lang']['direct_shopping']; ?>" onclick="location.href='flow.php?step=consignee&amp;direct_shopping=1'" />
                        <?php endif; ?>
            ...
            <form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
               <table width="98%" border="0" cellpadding="8" cellspacing="5" bgcolor="#FCEADC" class="table">
                  <tr>
            ...
            <span style="color:#FF0000" id="conform_password_notice"></span></td>
                  ...
                  <tr>
                    ...
                    <td  bgcolor="#ffffff" align="left">
                        <input type="submit" name="Submit" class="nor_btn" value="<?php echo $this->_var['lang']['forthwith_register']; ?>" />
          ...
          <tr>
            <td bgcolor="#ffffff" ></td>
            <td  align="left" style="border-top:1px #ccc solid; padding:5px; color:red;"><?php echo $this->_var['lang']['gift_remainder']; ?></td>
          </tr>
          <?php endif; ?>
        </table>
        </div>
