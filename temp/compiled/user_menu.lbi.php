...
<?php endif; ?>
<a href="user.php?act=talent_collection_list"<?php if ($this->_var['action'] == 'talent_collection_list'): ?>class="curs"<?php endif; ?>><img src="themes/default/images/u5.gif"> 人才收藏</a>
<a href="user.php?act=talent_request"<?php if ($this->_var['action'] == 'talent_request'): ?>class="curs"<?php endif; ?>><img src="themes/default/images/u2.gif"> 人才输送</a>
