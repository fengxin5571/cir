...
?>
                          <?php echo $this->_var['item']['type_name']; ?>: <?php if (isset ( $this->_var['item']['rank_name'] )): ?><?php echo $this->_var['item']['rank_name']; ?>,  付费时间：<?php echo $this->_var['item']['start_time']; ?>，结束时间：<?php echo $this->_var['item']['end_time']; ?><?php else: ?>无此模块权限<?php endif; ?><br />
                          ...
                          <?php echo $this->_var['lang']['not_validated']; ?> <a href="javascript:sendHashMail()" style="color:#006bd0;"><?php echo $this->_var['lang']['resend_hash_mail']; ?></a><br />
                           <?php endif; ?>
                           <div style="margin:5px 0; border:1px solid #fc7203;padding:10px 20px; background-color:#ffba83;">
