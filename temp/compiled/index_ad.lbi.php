...
?>
                  <li><a href="<?php echo $this->_var['ad']['url']; ?>" title="<?php echo $this->_var['ad']['text']; ?>" target="_blank"><img src="<?php echo $this->_var['ad']['src']; ?>" width="660" height="397" alt="<?php echo $this->_var['ad']['text']; ?>" /></a></li>
