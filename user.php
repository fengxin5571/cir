...
'account_deposit', 'account_log', 'account_detail', 'act_account', 'pay', 'default', 'bonus', 'group_buy', 'group_buy_detail', 'affiliate', 'comment_list','validate_email','track_packages', 'transform_points','qpassword_name', 'get_passwd_question', 'check_answer', 'talent_collection_list', 'talent_request');
...
elseif ($action == 'talent_collection_list')
{
    ...
    $record_count = $db->getOne("SELECT COUNT(*) FROM " .$ecs->table('collect_talent').
                                " WHERE user_id='$user_id' ORDER BY add_time DESC");
...
elseif ($action == 'talent_request')
{
    ...
    $record_count = $db->getOne("SELECT COUNT(*) FROM " .$ecs->table('talent_request').
                                " WHERE user_id='$user_id' ORDER BY msg_time DESC");
