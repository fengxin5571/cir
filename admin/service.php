...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('service')."(cat_name, cat_type, cat_desc, keywords, sort_order)
           VALUES ('$_POST[cat_name]', '$_POST[cat_type]', '$_POST[cat_desc]','$_POST[keywords]', '$_POST[sort_order]')";
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    if ($exc->edit("cat_name = '$_POST[cat_name]', cat_type = '$_POST[cat_type]', cat_desc ='$_POST[cat_desc]', keywords='$_POST[keywords]',sort_order='$_POST[sort_order]'",  $_POST['id']))
    {
